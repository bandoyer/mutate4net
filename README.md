...
- Richer expression mutators for strings, numeric literals, compound assignments, increment/decrement operators, conditional branches, selected LINQ calls, and conservative invocation statement removal.
